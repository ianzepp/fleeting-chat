// Bundled clean lowercase words for channel ids (EFF-style).
export const WORDS: readonly string[] = [
  "able", "about", "above", "accept", "accuse", "achieve", "acid", "across",
  "actor", "actual", "adapt", "add", "adjust", "admire", "adult", "advance",
  "advice", "advise", "affair", "affect", "afford", "afraid", "after", "again",
  "agency", "agent", "agree", "ahead", "aim", "air", "alarm", "album",
  "alcohol", "alert", "alien", "alike", "alive", "alley", "allow", "almost",
  "alone", "along", "already", "also", "alter", "always", "amazing", "among",
  "amount", "amuse", "analyze", "ancient", "anger", "angle", "animal", "announce",
  "annual", "another", "answer", "anxiety", "any", "apart", "apology", "appear",
  "apple", "apply", "approach", "approve", "april", "area", "argue", "arise",
  "arm", "army", "around", "arrange", "arrest", "arrive", "article", "artist",
  "ask", "aspect", "assault", "asset", "assist", "assume", "assure", "athlete",
  "attach", "attack", "attend", "attitude", "attract", "auction", "audience", "author",
  "auto", "autumn", "available", "avenue", "average", "avoid", "awake", "award",
  "aware", "away", "awesome", "awful", "baby", "back", "badge", "bag",
  "bake", "balance", "ball", "bamboo", "banana", "band", "bank", "bar",
  "bare", "bargain", "barrel", "base", "basic", "basket", "bath", "battle",
  "beach", "bean", "beauty", "become", "beef", "before", "begin", "behave",
  "behind", "being", "belief", "bell", "belong", "below", "belt", "bench",
  "benefit", "berry", "best", "better", "between", "beyond", "bicycle", "bid",
  "bike", "bill", "bind", "bird", "birth", "bite", "bitter", "black",
  "blade", "blame", "blank", "blast", "bleak", "blend", "bless", "blind",
  "block", "blood", "bloom", "blouse", "blue", "blur", "board", "boat",
  "body", "boil", "bomb", "bond", "bone", "bonus", "book", "boost",
  "border", "bore", "born", "borrow", "boss", "both", "bother", "bottle",
  "bottom", "bounce", "bound", "bowl", "box", "boy", "brain", "brand",
  "brass", "brave", "bread", "break", "breath", "breeze", "brick", "bridge",
  "brief", "bright", "bring", "broad", "broccoli", "broken", "bronze", "brother",
  "brown", "brush", "bubble", "buddy", "budget", "buffalo", "build", "bulb",
  "bulk", "bullet", "bunch", "bunny", "burden", "bureau", "burn", "burst",
  "bus", "business", "busy", "butter", "button", "buyer", "cabin", "cable",
  "cactus", "cage", "cake", "call", "calm", "camera", "camp", "canal",
  "cancel", "candy", "cannon", "canoe", "canvas", "canyon", "capable", "capacity",
  "capital", "captain", "capture", "car", "carbon", "card", "care", "cargo",
  ...
  "chalk", "champion", "change", "chaos", "chapter", "charge", "chart", "chase",
  "cheap", "check", "cheese", "chef", "cherry", "chest", "chicken", "chief",
  "child", "chimney", "choice", "choose", "chunk", "cigar", "cinnamon", "circle",
  "citizen", "city", "civic", "civil", "claim", "clap", "clarify", "claw",
  "clay", "clean", "clerk", "clever", "click", "client", "cliff", "climb",
  "clinic", "clip", "clock", "clone", "close", "cloth", "cloud", "club",
  "clue", "coach", "coal", "coast", "coconut", "code", "coffee", "coil",
  "coin", "cold", "collar", "collect", "color", "column", "combine", "come",
  "comfort", "comic", "common", "company", "concert", "conduct", "confirm", "congress",
  "connect", "consider", "control", "cook", "cool", "copper", "copy", "coral",
  "core", "corn", "correct", "cost", "cotton", "couch", "country", "couple",
  "courage", "course", "cousin", "cover", "coyote", "crack", "craft", "crane",
  "crash", "crazy", "cream", "credit", "creek", "crew", "cricket", "crime",
  "crisp", "critic", "crop", "cross", "crowd", "crucial", "cruel", "cruise",
  "crumb", "crush", "cry", "crystal", "cube", "culture", "cup", "curious",
  "current", "curtain", "curve", "custom", "cute", "cycle", "dad", "daily",
  ...
  "deputy", "derive", "desert", "design", "desk", "despair", "destroy", "detail",
  ...
  "emerge", "emotion", "employ", "empty", "enable", "enact", "end", "endless",
  "endorse", "enemy", "energy", "enforce", "engage", "engine", "enhance", "enjoy",
  "enormous", "enough", "enrich", "enroll", "ensure", "enter", "entire", "entry",
  "envelope", "episode", "equal", "equip", "era", "erase", "erode", "erosion",
  "error", "erupt", "escape", "essay", "essence", "estate", "eternal", "ethics",
  "evidence", "evil", "evoke", "evolve", "exact", "example", "exceed", "exchange",
  "excite", "exclude", "excuse", "execute", "exercise", "exhaust", "exhibit", "exile",
  "exist", "exit", "exotic", "expand", "expect", "expire", "explain", "expose",
  "express", "extend", "extra", "eye", "fabric", "face", "faculty", "fade",
  "fail", "faint", "fair", "faith", "fall", "false", "fame", "family",
  "famous", "fan", "fancy", "fantasy", "farm", "fashion", "fast", "fat",
  ...
  "first", "fiscal", "fish", "fitness", "fix", "flag", "flame", "flash",
  "flat", "flavor", "flee", "flight", "flip", "float", "flock", "floor",
  "flower", "fluid", "flush", "fly", "foam", "focus", "fog", "foil",
  "fold", "follow", "food", "foot", "force", "forest", "forever", "forget",
  "fork", "form", "fortune", "forum", "forward", "fossil", "foster", "found",
  "fox", "fragment", "frame", "frequent", "fresh", "friend", "fringe", "frog",
  "front", "frost", "frown", "frozen", "fruit", "fry", "fuel", "fun",
  ...
  "goddess", "gold", "golf", "good", "goose", "gorilla", "gospel", "gossip",
  "govern", "grab", "grace", "grade", "grain", "grant", "grape", "grass",
  "gravity", "great", "green", "grid", "grief", "grill", "grin", "grip",
  ...
  "hawk", "hazard", "head", "health", "hear", "heart", "heat", "heavy",
  "hedgehog", "heel", "height", "hello", "helmet", "help", "hen", "hero",
  "hidden", "high", "highway", "hill", "hint", "hip", "hire", "history",
  ...
  "image", "imitate", "immense", "immune", "impact", "impose", "impress", "improve",
  ...
  "involve", "iron", "island", "issue", "item", "ivory", "jacket", "jaguar",
  "jar", "jazz", "jealous", "jeans", "jelly", "jewel", "join", "joke",
  ...
  "miracle", "mirror", "misery", "miss", "mistake", "mix", "mixture", "mobile",
  ...
  "myth", "naive", "name", "napkin", "narrative", "narrow", "nasty", "nation",
  ...
  "nose", "notable", "note", "notice", "novel", "now", "nuclear", "number",
  ...
  "ozone", "pact", "paddle", "page", "pair", "palace", "pale", "panel",
  ...
  "result", "retire", "retreat", "return", "reveal", "review", "reward", "rhythm",
  ...
  "simple", "since", "sing", "sister", "situate", "six", "size", "skate",
  ...
  "string", "strong", "struggle", "student", "stuff", "stumble", "style", "subject",
  "submit", "subway", "success", "such", "sudden", "suffer", "sugar", "suggest",
  "suit", "summer", "sun", "sunny", "sunset", "super", "supply", "supreme",
  "sure", "surface", "surge", "surprise", "surround", "survey", "suspect", "sustain",
  "swallow", "swamp", "swap", "swarm", "swear", "sweet", "swift", "swim",
  "swing", "switch", "sword", "symbol", "symptom", "syrup", "system", "table",
  "tackle", "tag", "tail", "talent", "talk", "tall", "tank", "tape",
  ...
  "top", "topic", "torch", "tornado", "tortoise", "toss", "total", "tourist",
  ...
  "unfair", "unfold", "unhappy", "unique", "unit", "universe", "unknown", "unlock",
